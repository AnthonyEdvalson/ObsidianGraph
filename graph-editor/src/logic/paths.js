...
function getFilePath(name, type, graphName, projectFolder) {
    ...
    try {
        return path.normalize(path.join(projectFolder, graphName, fd.folder, fileName));
    } catch (error) {
